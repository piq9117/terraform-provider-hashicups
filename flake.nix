      ...
      devShells = forAllSystems (system:
        ...
        in {
          default = pkgs.mkShell {
            ...
            HASHICUPS_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NzMxMDQ2NDUsInVzZXJfaWQiOjEsInVzZXJuYW1lIjoiZWR1Y2F0aW9uIn0.VDSQgmDp3BBh9WwyWzoW1-uKiCprC928naOcZ750glw";
